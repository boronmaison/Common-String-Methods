...
// Trim the string to remove extra spaces and newline
let trimmedString = inputString.trim();

// 1. Searching
let hasJavaScript; // let hasJavaScript = trimmedString.includes("JavaScript");console.log("Has JavaScript:", hasJavaScript);
let codingPosition; // let codingPosition = trimmedString.indexOf("Coding");console.log("Position of 'Coding':", codingPosition);
let startsWithWelcome; // let startsWithWelcome = trimmedString.startsWith("Welcome");console.log("Starts with 'Welcome':", startsWithWelcome);
let endsWithToday; // let endsWithToday = trimmedString.endsWith("today.");console.log("Ends with 'today.':", endsWithToday);

// 2. Transforming
let lowercaseString; // let lowercaseString = inputString.toLowerCase();console.log("Lowercase:", lowercaseString);
let uppercaseString; // let uppercaseString = inputString.toUpperCase();console.log("Uppercase:", uppercaseString);
let trimmedString; // let trimmedString = inputString.trim();console.log("Trimmed:", trimmedString);
let replacedString; // let replacedString = inputString.replace("JavaScript", "coding");console.log("Replaced:", replacedString);

// 3. Breaking Apart
let wordsArray; // let wordsArray = inputString.trim().split(" ");console.log("Words Array:", wordsArray);


// 4. Retrieving
let firstCharacter; // let firstCharacter = trimmedString.charAt(0);console.log("First Character:", firstCharacter);
let extractedBootcamp; // let startIndex = trimmedString.indexOf("Bootcamp");let extractedBootcamp = trimmedString.slice(startIndex, startIndex + "Bootcamp".length);console.log("Extracted 'Bootcamp':", extractedBootcamp);
